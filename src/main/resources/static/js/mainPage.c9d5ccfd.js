      ...
      var n = function () {
          ...
          return a(
            ...
            [
              ...
              a("Tags", {
                attrs: { className: "MainPage-Tags" },
                on: { "select-tag": t.onClickTag },
              }),
            ],
            1
          );
        ...
        l = {
          name: "mainPage",
          components: { Articles: c, Tags: r },
          data: function () {
            return {
              navItems: [
                { name: "Новые", value: "recent" },
                { name: "Самые обсуждаемые", value: "popular" },
                { name: "Лучшие", value: "best" },
                { name: "Старые", value: "early" },
              ],
              tagSelected: "",
            };
          },
          ...
          mounted: function () {
            this.$route.params.tag &&
              (this.tagSelected = this.$route.params.tag);
          },
          metaInfo: function () {
            return {
              title: this.blogInfo
        ...
        u = l,
        m = (a("5872"), a("2877")),
        g = Object(m["a"])(u, n, s, !1, null, null, null);
      e["default"] = g.exports;
    },
    "8abe": function (t, e, a) {},
  },
