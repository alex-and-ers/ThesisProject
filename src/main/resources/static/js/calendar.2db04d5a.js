  ...
  ["calendar"],
  {
      ...
      var n = function () {
          ...
          return e(
            ...
            [
              ...
              e("CalendarTable", { attrs: { year: t.year, posts: t.posts } }),
            ],
            1
          );
        },
        r = [],
        o = (e("99af"), e("c740"), e("d81d"), e("d3b7"), e("5530")),
        s = e("2f62"),
        c = e("bc3a"),
        i = e.n(c),
        u = e("8c89"),
        ...
        l = {
          name: "Calendar",
          components: { BaseNavbar: d, CalendarTable: f },
          data: function () {
            return {
              activeYearIndex: 0,
              years: [],
          ...
          methods: {
            getPostsCount: function () {
              var t = this;
              return i.a
                .get("".concat(u["a"], "/api/calendar?year=").concat(this.year))
                .then(function (a) {
        ...
        p = l,
        h = (e("0a91"), e("2877")),
        b = Object(h["a"])(p, n, r, !1, null, null, null);
      a["default"] = b.exports;
    },
    c740: function (t, a, e) {
      "use strict";
    ...
    d81d: function (t, a, e) {
      ...
      var n = e("23e7"),
        ...
        i = s("map");
      n(
        { target: "Array", proto: !0, forced: !c || !i },
        {
          map: function (t) {
            return r(this, t, arguments.length > 1 ? arguments[1] : void 0);
          },
