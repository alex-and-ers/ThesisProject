  ...
  ["baseArticle"],
  {
        ...
        s = function (t) {
          return function (e, i, s) {
            ...
            return v <= d || "" == f
              ? l
              : ((c = v - d),
                (u = n.call(f, o(c / f.length))),
                u.length > c && (u = u.slice(0, c)),
                t ? l + u : u + l);
          };
        };
    ...
    "5e98": function (t, e, i) {
      ...
      var r = function () {
          ...
          return i(
            "transition",
            { attrs: { name: t.forModeration ? "article-moderation" : "" } },
            [
              i(
                "div",
                {
                  ...
                  i(
                    ...
                    [
                      i(
                        ...
                        [
                          t._v(
                            " " + t._s(t._f("formatRelTime")(t.timestamp)) + " "
                          ),
                          i("div", { staticClass: "Time-TooltipText" }, [
                            t._v(
                              " " +
                                t._s(t._f("formatAbsTime")(t.timestamp)) +
                                " "
                            ),
                          ]),
                        ]
                  ...
                  t.isPreview
                    ? i(
                        "router-link",
                        {
                          ...
                          attrs: {
                            to: { name: "article", params: { id: "" + t.id } },
                          },
                        },
                        [t._v(" " + t._s(t.title) + " ")]
                      )
                    : i("div", { staticClass: "Article-Title" }, [
                        t._v(" " + t._s(t.title) + " "),
                      ]),
                  i(
                    "div",
                    ...
                    [
                      t.isPreview
                        ? [t._v(" " + t._s(t._f("formatText")(t.text)) + " ")]
                        : i("span", {
                            domProps: { innerHTML: t._s(t.htmlText) },
                          }),
                    ],
                    2
                  ),
                  t.forModeration || t.myPosts
                    ? i("ModerationBlock", {
                        attrs: {
        ...
        n = [],
        a = (i("a9e3"), i("d3b7"), i("ac1f"), i("5319"), i("bc3a")),
        o = i.n(a),
        s = i("8c89"),
        c = i("ed08"),
        u = i("2b0e"),
        ...
        f = {
          ...
          methods: {
                ...
                o.a
                  ...
                  .then(function (e) {
                    e.data.result &&
                      (t.likes++,
                      t.liked++,
                      1 === t.disliked && (t.dislikes--, (t.disliked = 0)));
                  })
                  .catch(function (e) {
            ...
            onDislike: function () {
              ...
              0 === this.disliked &&
                o.a
                  .post("".concat(s["a"], "/api/post/dislike"), {
                    post_id: this.id,
                  })
                  .then(function (e) {
                    e.data.result &&
        ...
        v = f,
        h = (i("8256"), i("2877")),
        p = Object(h["a"])(v, r, n, !1, null, null, null);
      e["default"] = p.exports;
    },
    7156: function (t, e, i) {
      var r = i("861d"),
          ...
          if ("string" == typeof u && u.length > 2)
            if (((u = m(u)), (e = u.charCodeAt(0)), 43 === e || 45 === e)) {
              ...
              for (a = u.slice(2), o = a.length, s = 0; s < o; s++)
                if (((c = a.charCodeAt(s)), c < 48 || c > n)) return NaN;
              return parseInt(a, r);
            }
          return +u;
        };
