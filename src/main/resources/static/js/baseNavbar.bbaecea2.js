  ...
  ["baseNavbar"],
  {
      ...
      var a = n("83ab"),
        ...
        _ = function (t) {
          ...
          if ("string" == typeof u && u.length > 2)
            if (((u = d(u)), (e = u.charCodeAt(0)), 43 === e || 45 === e)) {
              ...
              for (i = u.slice(2), c = i.length, s = 0; s < c; s++)
                if (((o = i.charCodeAt(s)), o < 48 || o > r)) return NaN;
              return parseInt(i, a);
            }
          return +u;
        };
    ...
    c8ce: function (t, e, n) {
      ...
      var a = function () {
          ...
          return n(
            "nav",
            { staticClass: "Nav", class: t.className },
          ...
          (n("a9e3"),
          {
            ...
            methods: {
              onClick: function (t, e) {
                (this.activeItem = t),
                  this.$emit("set-nav-value", t),
                  void 0 !== this.activeNavIndex && this.$router.push(e);
              },
            },
            mounted: function () {
              void 0 !== this.activeNavIndex &&
                (this.activeItem = this.activeNavIndex);
            },
          }),
        c = i,
        s = (n("f11c"), n("2877")),
        o = Object(s["a"])(c, a, r, !1, null, null, null);
      e["default"] = o.exports;
    },
    f11c: function (t, e, n) {
      "use strict";
