    ...
    "3a03": function (e, t, s) {
      ...
      var a = function () {
          ...
          return s(
            ...
            [
              ...
              s(
                ...
                {
                  class: [
                    e.forModeration || e.myPosts
                      ? "Articles-Content Articles-Content--noborder"
                      : "Articles-Content",
                  ],
                },
                [
                  e.articlesAreErrored
                    ? s("div", { staticClass: "ServerInfo" }, [
                        e._v(" Sorry, some error happened :( "),
                      ])
                    : [
                        e.daySelected
                          ? s("div", { staticClass: "Title Articles-Title" }, [
                              e._v(" Публикации " + e._s(e.formatedDate) + " "),
                            ])
                          : e._e(),
                        e.tagSelected
                          ? s("div", { staticClass: "Title Articles-Title" }, [
                              e._v(
                                " Публикации по тэгу #" +
                                  e._s(e.tagSelected.toUpperCase()) +
                                  " "
                              ),
                            ])
                          : e._e(),
                        e.searchQuery && e.articles.length > 0
                          ? s("div", { staticClass: "Title Articles-Title" }, [
                              e._v(' Поиск по "' + e._s(e.searchQuery) + '" '),
                            ])
                          : e._e(),
                        e.searchQuery &&
                        0 === e.articles.length &&
                        !e.articlesAreLoading
                          ? s("div", { staticClass: "Title Articles-Title" }, [
                              e._v(
                                ' По запросу "' +
                                  e._s(e.searchQuery) +
                        ...
                        e.searchQueryIsEmpty
                          ? s("div", { staticClass: "Title Articles-Title" }, [
                              e._v(" Задан пустой поисковый запрос "),
                            ])
                          : e._e(),
                        ...
                        e.moreArticles && !e.articlesAreLoading
                          ? s(
                              "div",
                              { staticClass: "Articles-Button" },
                              [
                                s(
                                  "BaseButton",
                                  {
        ...
        u = {
          ...
          computed: Object(i["a"])(
            ...
            ]),
            {
              classObject: function () {
                var e = "Articles";
                return (
                  this.className && (e += " ".concat(this.className)),
                  (this.myPosts || this.forModeration) && (e += " Wrapper"),
                  e
                );
              },
              ...
              formatedDate: function () {
                return (
                  !!this.daySelected &&
                  new Date(this.daySelected).toLocaleString("ru-RU", {
                    year: "numeric",
                    month: "2-digit",
                    day: "2-digit",
                  })
          ...
          methods: Object(i["a"])(
            {},
            Object(n["mapMutations"])([
              "clearArticles",
              "clearSearchQuery",
              "clearSelectedDay",
            ]),
            {},
            Object(n["mapActions"])(["getArticles", "moderateArticle"]),
            {
              ...
              selectMethod: function () {
                ...
                if (this.forModeration)
                  e = this.makeQuery("status", "/moderation");
                else if (this.myPosts) e = this.makeQuery("status", "/my");
                else if (this.tagSelected) e = this.makeQuery("tag", "/byTag");
                else if (this.daySelected)
                  e = this.makeQuery("date", "/byDate");
                else if (this.searchQuery)
                  e = this.makeQuery("query", "/search");
                else {
              ...
              getValue: function () {
                return this.tagSelected
                  ...
                  : this.searchQuery
                  ? this.searchQuery
                  : this.navItems[this.activeNavIndex].value;
              },
              makeQuery: function (e) {
                ...
                return ""
                  .concat(t, "?offset=")
                  .concat(this.offset, "&limit=")
                  .concat(this.articlesNumber, "&")
                  .concat(e, "=")
                  .concat(s);
              },
              onLoadMore: function () {
                this.articlesCount > this.offset + this.articlesNumber &&
                  ((this.offset += this.articlesNumber), this.selectMethod());
              },
          ...
          metaInfo: function () {
            var e;
            if (this.tagSelected)
              e = "Публикации по тэгу #".concat(this.tagSelected);
            else if (this.forModeration) e = "Модерирование публикаций";
            else if (this.myPosts) e = "Мои публикации";
            else if (this.postByDate)
              e = "Публикации за ".concat(this.formatedDate);
            else {
              if (!this.searchQuery) return "DevPub - рассказы разработчиков";
              e = 'Искать "'.concat(this.searchQuery, '"');
            }
            return {
              title: "".concat(e, " | DevPub - рассказы разработчиков"),
            };
          },
        },
        d = u,
        h = (s("2657"), s("2877")),
        f = Object(h["a"])(d, a, r, !1, null, null, null);
      t["default"] = f.exports;
    },
    c740: function (e, t, s) {
      "use strict";
