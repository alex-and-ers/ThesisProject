      ...
      var r = function () {
          ...
          return a(
            ...
            [
              ...
              a("div", { staticClass: "Form-Name" }, [
                a("div", { staticClass: "Form-Row" }, [
                  a("div", { staticClass: "Form-Label" }, [t._v(" Имя ")]),
                  a("div", { staticClass: "Form-Value" }, [
                    a("input", {
                      directives: [
                        {
                          name: "model",
                    ...
                    t.authErrors.name
                      ? a("div", { staticClass: "Login-Errors" }, [
                          a("div", { staticClass: "Input-Error" }, [
                            t._v(" " + t._s(t.authErrors.name) + " "),
                          ]),
                        ])
                      : t._e(),
                  ]),
        ...
        n = [],
        s = (a("99af"), a("b0c0"), a("b64b"), a("d3b7"), a("5530")),
        i = a("d860"),
        o = a("0d38"),
        u = function () {
          ...
          methods: {
            onSubmit: function () {
              ...
              this.$store
                .dispatch(
                  "register",
                  Object(s["a"])({}, this.validatedFields, { name: this.name })
                )
                .then(function () {
                  Object.keys(t.authErrors).length ||
                    t.$router.push({ name: "registration-success" });
                })
                .catch(function (e) {
        ...
        h = f,
        m = a("2877"),
        v = Object(m["a"])(h, r, n, !1, null, null, null);
      e["default"] = v.exports;
    },
    "0d38": function (t, e, a) {
      "use strict";
      ...
      e["a"] = {
        ...
        mounted: function () {
          var t = this;
          n.a
            .get("".concat(s["a"], "/api/auth/captcha"))
            .then(function (e) {
              (t.image = e.data.image),
                (t.validatedFields.secret = e.data.secret);
            })
            .catch(function (e) {
      ...
      var r = a("83ab"),
        ...
        o = function (t) {
          return function (e) {
            ...
            while (c > l)
              (a = u[l++]),
                (r && !i.call(o, a)) || d.push(t ? [a, o[a]] : o[a]);
            return d;
          };
        };
      ...
      e["a"] = {
        ...
        methods: {
          onValidateField: function (t) {
            this.validatedFields = Object(r["a"])(
              {},
