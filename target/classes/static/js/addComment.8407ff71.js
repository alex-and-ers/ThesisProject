      ...
      var o = function () {
          ...
          return n(
            ...
            [
              t.isReply
                ? t._e()
                : n("div", { staticClass: "Title AddComment-Title" }, [
                    t._v(" Добавить комментарий "),
                  ]),
              n("AddText", {
                ref: "addText",
                attrs: { className: "AddComment-Edit" },
                model: {
                  value: t.commentTextData,
                  callback: function (e) {
                    t.commentTextData = e;
                  },
              ...
              n(
                "div",
                { staticClass: "AddComment-Send" },
                [
                  n("BaseButton", { attrs: { onClickButton: t.sendComment } }, [
                    t._v(" Отправить "),
                  ]),
                ],
                1
        ...
        i = {
          ...
          methods: Object(c["a"])(
            {},
            Object(s["mapMutations"])(["updateCommentText"]),
            {},
            Object(s["mapActions"])(["sendComment"]),
            {
              focus: function () {
        ...
        u = i,
        l = (n("9cf9"), n("2877")),
        r = Object(l["a"])(u, o, a, !1, null, null, null);
      e["default"] = r.exports;
    },
  },
]);
