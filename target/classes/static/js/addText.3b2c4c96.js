    ...
    ce13: function (t, e, s) {
      ...
      var i = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { staticClass: "AddText", class: t.className }, [
            s(
              "div",
              { staticClass: "AddText-Edit" },
              [s("Vueditor", { ref: "editor" })],
              1
            ),
          ]);
        },
        ...
        o = {
          ...
          mounted: function () {
            ...
            this.$refs.editor.setContent(this.value),
              (this.editorUnsubscribe = this.$refs.editor.$store.subscribe(
                function (e, s) {
                  "UPDATE_CONTENT" === e.type &&
                    t.lastText !== s.content &&
                    ((t.lastText = s.content), t.$emit("input", s.content));
                }
              )),
        ...
        c = o,
        u = (s("42ff"), s("2877")),
        a = Object(u["a"])(c, i, n, !1, null, null, null);
      e["default"] = a.exports;
    },
  },
]);
