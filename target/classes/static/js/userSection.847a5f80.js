    ...
    e3ce: function (t, e, r) {
      ...
      var n = function () {
          var t = this,
            e = t.$createElement,
            r = t._self._c || e;
          return r("div", { staticClass: "UserSection" }, [
            r("div", { staticClass: "UserSection-Outer" }, [
              r("div", { staticClass: "UserSection-User" }, [
            ...
            r(
              ...
              [
                ...
                t.user.moderation || t.settings.MULTIUSER_MODE
                  ? r(
                      "router-link",
                      {
                        staticClass: "Link UserSection-Item",
                ...
                t.user.moderation
                  ? r(
                      ...
                      {
                        staticClass:
                          "Link UserSection-Item UserSection-Moderation",
                        attrs: { to: "/moderation/new" },
                      },
                      [
                        r("div", [t._v(" Модерация ")]),
                        r("div", { staticClass: "UserSection-ModerationNum" }, [
                          t._v(" " + t._s(t.user.moderationCount) + " "),
                        ]),
                      ]
                    )
                  : t._e(),
        ...
        s = {
          computed: Object(i["a"])(
            {},
            Object(o["mapGetters"])(["user", "settings"])
          ),
          methods: Object(i["a"])({}, Object(o["mapActions"])(["logout"]), {
            loadAvatar: c["d"],
          }),
        },
        u = s,
        v = (r("8c6d"), r("2877")),
        f = Object(v["a"])(u, n, a, !1, null, null, null);
      e["default"] = f.exports;
    },
    ed08: function (t, e, r) {
      "use strict";
