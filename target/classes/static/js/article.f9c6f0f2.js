    ...
    8192: function (t, e, r) {
      ...
      var n = function () {
          ...
          return r(
            ...
            [
              t.articleIsErrored
                ? r("div", { staticClass: "ServerInfo" }, [
                    t._v(" Sorry, some error happened :( "),
                  ])
                : t._e(),
              t.articleIsLoading || t.articleIsErrored
                ? t._e()
                : r("BaseArticle", {
                    key: t.article.id,
                    attrs: {
              ...
              t.articleIsLoading || t.articleIsErrored || !t.article.comments
                ? t._e()
                : r(
                    "div",
                    { staticClass: "Comments" },
                    [
                      r("div", { staticClass: "Title Comments-Title" }, [
                        t._v(" Комментарии "),
                      ]),
                      t._l(t.article.comments, function (e) {
              ...
              t.articleIsLoading || t.articleIsErrored || !t.isAuth
                ? t._e()
                : r("AddComment", { ref: "addComment" }),
            ],
            1
          );
        },
        i = [],
        a = (r("99af"), r("b0c0"), r("d3b7"), r("2ca0"), r("1e25"), r("5530")),
        o = r("2f62"),
        c = function () {
        ...
        u = {
          ...
          methods: Object(a["a"])(
            {},
            Object(o["mapActions"])(["getArticle"]),
            {},
            Object(o["mapMutations"])(["replyOnComment", "updateCommentText"]),
            {
              reply: function (t) {
                this.replyOnComment(t);
                var e = "<strong>".concat(
                  this.commentParent.user.name,
                  "</strong>, "
                );
                this.commentParent &&
                  !this.commentText.startsWith(e.trimRight()) &&
                  this.updateCommentText(e),
        ...
        m = u,
        d = (r("7999"), r("2877")),
        f = Object(d["a"])(m, n, i, !1, null, null, null);
      e["default"] = f.exports;
    },
    ab13: function (t, e, r) {
      var n = r("b622"),
