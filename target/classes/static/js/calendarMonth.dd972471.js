        ...
        o = function (t) {
          return function (a, e, o) {
            ...
            return l <= f || "" == d
              ? u
              : ((c = l - f),
                (h = r.call(d, s(c / d.length))),
                h.length > c && (h = h.slice(0, c)),
                t ? u + h : h + u);
          };
        };
    ...
    a367: function (t, a, e) {
      ...
      var n = function () {
          var t = this,
            a = t.$createElement,
            e = t._self._c || a;
          return e("div", { staticClass: "CalendarMonth" }, [
            e("div", { staticClass: "CalendarMonth-Title" }, [
              t._v(" " + t._s(t.monthNames[t.month]) + " "),
            ]),
            e(
              "div",
              { staticClass: "CalendarMonth-Table" },
              [
                e(
                  "div",
                  { staticClass: "CalendarMonth-Day CalendarMonth-Weekday" },
                  [t._v(" пн ")]
                ),
                e(
                  "div",
                ...
                e(
                  ...
                  {
                    staticClass:
                      "CalendarMonth-Day CalendarMonth-Weekday CalendarMonth-Weekday--Weekend",
                  },
                  [t._v(" сб ")]
                ),
                e(
                ...
                t._l(t.days, function (a, n) {
                  return e(
                    "div",
                    { key: n, staticClass: "CalendarMonth-Day" },
                    [
                      t.getPostsCountByDate(a)
                        ? e(
                            "div",
                            {
                              staticClass: "CalendarMonth-Link",
                              on: {
                                click: function (e) {
                            ...
                            [
                              e(
                                "div",
                                { staticClass: "CalendarMonth-PostsCount" },
                                [
                                  t._v(
                                    " " + t._s(t.getPostsCountByDate(a)) + " "
                                  ),
                                ]
                              ),
                              e(
                                "div",
                                { staticClass: "CalendarMonth-DayNum" },
                                [t._v(" " + t._s(a) + " ")]
                              ),
                            ]
                          )
                        : [
                            e("div", { staticClass: "CalendarMonth-DayNum" }, [
                              t._v(" " + t._s(a) + " "),
                            ]),
                          ],
                    ],
        ...
        c = {
          ...
          methods: Object(i["a"])(
            {},
            Object(o["mapMutations"])(["setSelectedDay"]),
            {
              setDateInfo: function () {
                var t = new Date(this.year, this.month);
                switch (
                  ((this.offset = t.getDay() - 1 > 0 ? t.getDay() - 1 : 6),
                  this.month)
                ) {
                  case 0:
                  case 2:
              ...
              onSelectDay: function (t) {
                this.$router.push(
                  "".concat(this.$route.params.year, "/").concat(t)
                );
              },
            }
          ),
        ...
        h = c,
        u = (e("747c"), e("2877")),
        f = Object(u["a"])(h, n, r, !1, null, null, null);
      a["default"] = f.exports;
    },
    c0fc: function (t, a, e) {},
    ed08: function (t, a, e) {
